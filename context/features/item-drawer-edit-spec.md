...
- Clicking away while the drawer is open in edit mode & changes are unsaved is prevented and shows an alert "you have unsaved changes"
- When editing Tags, as i type the tag and hit comma, it should auto comvert to the pill to indicate the tag is saved/read
